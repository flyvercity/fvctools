 $token = $(aws codeartifact get-authorization-token --domain flyvercity --domain-owner 368281077578 --region eu-west-3 --query authorizationToken --output text)
...
pip install --index-url $repo fvctools
